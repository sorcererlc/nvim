...
require('lazy').setup({
  ...
  require 'kickstart.plugins.nvim_telescope',
  require 'kickstart.plugins.lazydev',
  require 'kickstart.plugins.luvit_meta',
  require 'kickstart.plugins.nvim_lspconfig',
  require 'kickstart.plugins.conform',
  require 'kickstart.plugins.nvim_cmp',
  require 'kickstart.plugins.todo_comments',
  require 'kickstart.plugins.mini',
  require 'kickstart.plugins.nvim_treesitter',
